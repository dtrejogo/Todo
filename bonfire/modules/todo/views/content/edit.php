...
<div>
 <?php echo form_label('Completed', 'todo_completed'); ?> <span class="required">*</span>
 <?php print form_dropdown('todo_completed', array('1'=>'Yes','0'=>'No'), set_value('todo_completed', isset($todo['todo_completed']) ? $todo['todo_completed'] : '')); ?>
</div>

<div class="text-right">
    <br/>
    <input type="submit" name="submit" value="Edit Todo" /> or <a href="#index"><?php print lang('todo_back') ?></a>
</div>
<?php echo form_close(); ?>
